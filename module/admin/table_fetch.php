<?php
 session_start();
  ...
  ';
                 ...
                 $sql ="SELECT * FROM ((grade INNER JOIN student ON grade.Reg_no = student.Reg_no) INNER JOIN subject ON grade.sub_cod = subject.sub_cod) WHERE grade.sub_cod='".$subject."' AND student.stream='".$stream."' AND term_id='".$_SESSION['term_id']."' AND year='".$_SESSION['year']."' ORDER BY firstname ";
