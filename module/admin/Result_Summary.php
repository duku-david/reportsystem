...
<head>
  ...
  <?php
         $id = base64_decode($_GET['form']);
        function count_Query($grade,$sub_cod,$id)
        {
          include"../../service/connection.php";
            $sql ="SELECT COUNT(grade) AS count_result FROM `grade` INNER JOIN student ON grade.Reg_no=student.Reg_no INNER JOIN class ON class.c_id =student.c_id WHERE grade='".$grade."' AND sub_cod='".$sub_cod."' AND term_id='".$_SESSION['term_id']."' AND c_name='".$id."' AND year='".$_SESSION['year']."'";
  ...
  ?>
          ...
          <div class="formheadera">
            ...
            <a href="viewMark.php?form=<?php echo $_GET['form']?>" style="float: left; margin-left: 20px; margin-top: 3px;" class="btn btn-primary">Back</a>
          </div>  
    ...
    <tbody>
      <?php
               //Querying best five performers 
                 ...
                 $sql ="SELECT * FROM student INNER JOIN marksheet ON student.Reg_no = marksheet.Reg_no WHERE c_id IN (SELECT c_id FROM class WHERE c_name='".$id."') AND term_id='".$_SESSION['term_id']."' AND year='".$_SESSION['year']."' ORDER BY total DESC LIMIT 5";
  ...
  <div style="margin: 0px auto; width: 60%; margin-top: 20px;">
    ...
    <tbody>
      <?php   
                ...
                $sql ="SELECT * FROM student INNER JOIN marksheet ON student.Reg_no = marksheet.Reg_no WHERE c_id IN (SELECT c_id FROM class WHERE c_name='".$id."') AND term_id='".$_SESSION['term_id']."' AND year='".$_SESSION['year']."' ORDER BY total LIMIT 5";
