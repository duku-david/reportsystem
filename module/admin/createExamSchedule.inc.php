<?php
   ...
   if (isset($_POST['class']))
 {
  ...
  $sql ="SELECT DISTINCT c_name FROM class WHERE stream !=('Art') AND stream !='Science' AND c_id IN(SELECT c_id FROM student)";
  ...
  echo $msg;
	...
	if(isset($_POST['id']))
	{
		...
		}else
		{
			...
			$sql1 ="SELECT * FROM subject WHERE sub_cod ='".$exams[3]."'";
