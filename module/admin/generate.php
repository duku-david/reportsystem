...
.container
{
  ...
  width: 98%;
    ...
    <?php
    $sql="SELECT * FROM student INNER JOIN marksheet ON student.Reg_no = marksheet.Reg_no WHERE c_id IN (SELECT c_id FROM class WHERE c_name='".$form."') AND term_id='".$_SESSION['term_id']."' AND year='".$_SESSION['year']."'";
