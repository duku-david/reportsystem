...
<div class="modal fade" id="myModals" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php
      $sql = "SELECT COUNT(firstname) AS count_s FROM student WHERE year='".$_SESSION['year']."'";
                 $res_count =mysqli_query($conn,$sql) or die(mysqli_error($conn));
                 $res_ct_arry1=mysqli_fetch_array($res_count);
  ?>

<div class="formheadera">Number Of Students <span class="btn btn-info" style="border-radius: 200px; padding-left: 15px; padding-right: 15px;"><?php echo ($res_ct_arry1['count_s']); ?></span> </div>
   ...
   <div id="modal_output"></div>
     ...
     <div id="ostudent_output"></div>
        ...
        <?php include('../../footer.php');?>
         <script type="text/javascript" src="javascript/studentValidate.js">
