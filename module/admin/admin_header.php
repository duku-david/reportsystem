...
<body>
        ...
        <tr>
         ...
         <div class="topnav1" >
              <a href="index.php"  title="Home" class="btn btn-info" role="button">Home<i class="glyphicon glyphicon-home"></i></a>
                    <a href="markPage.php"  title="View Marks" class="btn btn-info" role="button">View Mark<i class="glyphicon glyphicon-list-alt"></i></a>
  ...
  <section>
      <div class="col-md5">
         ...
         <div class="left-float">
            <div class="image1">
              ...
              <div class="side-navi">
                 <a href="student.php">Register Student</a>
              </div>
             <!--  <div class="side-navi">
              ...
              <div class="side-navi">
                 <a href="postNotice.php">Add Notice To The Board</a>
              </div>
    ...
    <div class="main-wrapping1">
      <div class="main-wrapping" style="margin: 0px; padding: 0px;">
